...
namespace sdds{
    ...
    class Collection{
        ...
        T *collectionItems;
        size_t sizeArr;
        void (*addItemObserver)(const Collection<T>&, const T&); //Collection<T> tells us what the data type of the collection object is
        ...
        T& operator[](size_t idx) const
        {
            if(idx >= sizeArr){
                ...
                throw std::out_of_range("Bad index [" + idexStr + "]");
            }
            else{
